defmodule Exa.Color.Colorb do
  ...
  def from_bin(buf, :index), do: Col1b.from_bin(buf, :gray)
  ...
  def append_bin(buf, :index, col), do: Col1b.append_bin(buf, :gray, col)
  ...
  def to_bin(col, :gray), do: Col1b.to_bin(col, :gray)
  def to_bin(col, :index), do: Col1b.to_bin(col, :gray)
  def to_bin(col, :rgb), do: Col3b.to_bin(col, :rgb)
  def to_bin(col, :bgr), do: Col3b.to_bin(col, :bgr)
  def to_bin(col, :argb), do: Col4b.to_bin(col, :argb)
  def to_bin(col, :abgr), do: Col4b.to_bin(col, :abgr)
  def to_bin(col, :rgba), do: Col4b.to_bin(col, :rgba)
  def to_bin(col, :bgra), do: Col4b.to_bin(col, :bgra)
end
