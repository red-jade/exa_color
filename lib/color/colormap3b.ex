defmodule Exa.Color.Colormap3b do
  ...
  """
  @spec new([C.col3f()], :rgb | :hsl) :: I.colormap3b()
  ...
  @spec gradient(C.col3f(), C.col3f(), I.pixel()) :: I.colormap3b()
  ...
  @spec gradient(C.col3f(), C.col3f(), C.col3f(), I.pixel()) :: I.colormap3b()
  ...
  (for 3-component color).
  """
  @spec gradient([I.icol3f()], I.pixel()) :: I.colormap3b()
  ...
  """
  @spec validate!(I.colormap3b()) :: E.index0()
  def validate!({:colormap, :index, :rgb, cmap}) do
    imax = map_size(cmap) - 1
    ixs = cmap |> Map.keys() |> Enum.sort()

    if ixs != Range.to_list(0..imax) do
      raise ArgumentError, message: "Invalid index keys, expecting 0..#{imax}, found #{ixs}"
    end

    if imax > 255 do
      raise ArgumentError, message: "Colormap index exceeds 255, found #{imax}"
    end
  ...
  """
  @spec lookup(I.colormap3b(), byte()) :: C.col3f()
  ...
  @spec linear(I.icol3f(), I.icol3f(), I.cmap3b()) :: I.cmap3b()
  ...
  @spec convert(I.cmap3b(), I.pixel()) :: I.map3b()
